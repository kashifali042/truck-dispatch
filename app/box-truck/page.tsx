    ...
    <section className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 py-10 px-4">
      ...
      <div className="sm:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
        ...
        <div>
          ...
          <p className="mt-3 text-gray-600 leading-relaxed text-sm">
            With us, there is no minimum loads that you need to take on and it’s easy to close your Dispatch Experts account since there are also no contracts. There is no pressure on you, and if you feel that you want to take some time away, that’s your choice. Connect with us when you want to pick up a box truck load. 
          </p>
